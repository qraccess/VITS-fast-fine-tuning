[中文文档请点击这里](https://github.com/yihuitang/VITS-fast-fine-tuning/blob/main/README_ZH.md)
...
2. Choose pretrained model to start. The detailed differences between them are described in [Colab Notebook](https://colab.research.google.com/drive/1AwIOCB4ArTyn4J0R5ImfSo1gi0aEIzOW?usp=sharing)
